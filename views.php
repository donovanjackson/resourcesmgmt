...
function displayLayout(){
	echo '	
		...
		<!--dataTable-->
		<link href="dataTable-1.10.2/css/jquery.dataTables.min.css" rel="stylesheet">
		<link href="dataTable-1.10.2/css/jquery.dataTables_themeroller.css" rel="stylesheet">
		<script type="text/javascript" src="dataTable-1.10.2/js/jquery.dataTables.min.js"></script>
...
function displayLoggedInBar(){
	...
	<div id="loggedInBar"><div id="loggedIn"><span>
		...
		<span id="logout"><button type="button"  class="buttonLink"><a href="./index.php?action=logout">Logout</a></button></span>
		<br/><a href="./index.php?action=changePass">Change Password?</a></div>
	
	<div id="menu">
			<!--<div class="menuBox"><span><a href="./index.php">Home</a></span></div>-->
			<div class="menuBox"><span><a href="./index.php?page=Clients">Manage Clients</a></span></div>
			<div class="menuBox"><span><a href="./index.php?page=Resources">Manage Resources</a></span></div>
			<div class="menuBox"><span><a href="./index.php?page=Sows">Manage Sows</a></span></div>
			<div class="menuBox"><span><a href="./index.php?page=Requests">Manage Requests</a></span></div>
			<div class="menuBox"><span><a href="./index.php?page=Reports">Reports</a></span></div>';
	if($_SESSION['role']=="administrator") echo '<div class="menuBox" style="margin-left:5px;"><span><a href="./index.php?page=Users">Manage Users</a></span></div>';
...
function displayAdvancedSearchPage($conn){
	...
	echo'<form action="./index.php?page=ASResults" method="post">
...
echo ' | <button type="button"  class="buttonLink"><a href="./index.php?page=AdvancedSearch">Advanced Search</a></button>';
}
...
function displayASResultsPage($conn){
	...
	if($results){
		...
		<div class="searchbar">
				<form action="./index.php?page=Clients&action=Search" method="post">
					<input type="submit" name="search" value="Search Clients and Relations"> <input name="keyphrase" type="text" maxlength="45">';
		...
		<a href="./index.php?page=Clients&action=createClient">Create New Client</a></button></div>';
		
		
		echo'<div class="table-framer">';
	...
	if($results){
		foreach($results as $client){
				$client['sales_rep']=getClientsSRsAsString($conn,$client['sales_rep']);
			echo'
		<tr>
					...
					<td class="rowEntryAction"><a href="./index.php?page=Clients&action=viewClient&clientid='.$client['client_id'].'">View</a>
					<a href="./index.php?page=Clients&action=editClient&clientid='.$client['client_id'].'">Edit</a>';
					if($_SESSION['role']=="administrator")echo' <a class="deleteEntry" href="./index.php?page=Clients&action=deleteClient&clientid='.$client['client_id'].'">Delete</a>';
					echo'</td>
				</tr>';
		}	
	}	
	...
	if($results){
		...
		echo '<div class="pageListings">
		<div class="searchbar">
				<form action="./index.php?page=Resources&action=Search" method="post">
					<input type="submit" name="search" value="Search Resources And Relations"> <input name="keyphrase" type="text" maxlength="45">';
				displayAdvancedSearchOption();
				echo'<input type="hidden" name="action_token" value="';echo html_escape($_SESSION['action_token']);echo'" /></form>
			</div>';
		...
		<a href="./index.php?page=Resources&action=createResource">Create New Resource</a></button></div>';
		echo'<div class="table-framer">';
	echo '<table class="table-dataTable">
	<thead>
	<tr>
	...
	<tr>
				<td>'.$resource['resource_name'].'</td>
					<td>'.$resource['resource_lname'].'</td>
					<td>'.$resource['resource_fname'].'</td>
					<td>';
					if($resource['phone1']!=="")echo '1st: '.$resource['phone1'];
					if($resource['phone2']!=="")echo '<br/>2nd: '.$resource['phone2'];
					echo'</td>
					<td>';
				...
				echo $pskills;
					...
					<td>';
					if($resource['resume_upload']!=null)echo '<input type="button"class="viewer" data-url="./index.php?action=viewFile&directory=resume_uploads&filename='.$resource['resume_upload'].'" value="View Resume">';
					echo '</td>
					<td>';
					if($resource['resume_issi_upload']!=null)echo '<input type="button"class="viewer" data-url="./index.php?action=viewFile&directory=resume_issi_uploads&filename='.$resource['resume_issi_upload'].'" value="View Resume ISSI">';
					echo '</td>
					<td>'.$resource['resource_status'].'</td>
					<td class="rowEntryAction"><a href="./index.php?page=Resources&action=viewResource&resourceid='.$resource['resource_id'].'">View</a> 
					<a href="./index.php?page=Resources&action=editResource&resourceid='.$resource['resource_id'].'">Edit</a>';
				if($_SESSION['role']=="administrator")echo' <a class="deleteEntry" href="./index.php?page=Resources&action=deleteResource&resourceid='.$resource['resource_id'].'">Delete</a>';
				echo'</td>
			</tr>';
	}		
	echo'</tbody>
	...
	if($results){
		echo '<div class="pageListings">
		<div class="searchbar">
				<form action="./index.php?page=Requests&action=Search" method="post">
					<input type="submit" name="search" value="Search Requests And Relations"> <input name="keyphrase" type="text" maxlength="45">';
				displayAdvancedSearchOption();
				echo'<input type="hidden" name="action_token" value="';echo html_escape($_SESSION['action_token']);echo'" /></form>
			</div>';
		//Addition Options for page. not relevant to any particular entry.
		echo'<div class="mgmtTools"><button type="button" id="createSow" style="background:none;"  class="buttonLink">
		<a href="./index.php?page=Requests&action=createRequest">Create New Requests</a></button></div>';
	...
	if($results){
		...
		<tr>
					<td>'.$request['request_name'].'</td>
						...
						<td class="rowEntryAction"><a href="./index.php?page=Requests&action=viewRequest&requestid='.$request['request_id'].'">View</a> 
						<a href="./index.php?page=Requests&action=editRequest&requestid='.$request['request_id'].'">Edit</a>';
					if($_SESSION['role']=="administrator")echo' <a class="deleteEntry" href="./index.php?page=Requests&action=deleteRequest&requestid='.$request['request_id'].'">Delete</a>';
					echo'</td>
				</tr>';
		}
	}
	...
	if($results){
		...
		echo '<div class="pageListings">
		<div class="searchbar">
				<form action="./index.php?page=Sows&action=Search" method="post">
					<input type="submit" name="search" value="Search S.O.W.s and Relations"> <input name="keyphrase" type="text" maxlength="45">';
				displayAdvancedSearchOption();
				echo'<input type="hidden" name="action_token" value="';echo html_escape($_SESSION['action_token']);echo'" /></form>
			</div>';
		//Addition Options for page. not relevant to any particular entry.
		echo'<div class="mgmtTools"><button type="button" id="createSow" style="background:none;"  class="buttonLink">
		<a href="./index.php?page=Sows&action=createSow">Create New Sow</a></button></div>';
	...
	if($results){
		foreach($results as $sow){
			...
			<tr>
				...
				<td>';
				if($sow['sow_upload']!=null)echo '<input type="button"class="viewer" data-url="./index.php?action=viewFile&directory=sow_uploads&filename='.$sow['sow_upload'].'" value="View S.O.W. File">';
				echo '</td>
				<td>'.$sow['start_date'].'</td>
				<td>'.$sow['end_date'].'</td>
				<td>'.$sow['billing'].'</td>
				<td>'.$sow['sow_status'].'</td>
				<td class="rowEntryAction"><a href="./index.php?page=Sows&action=viewSow&sowid='.$sow['sow_id'].'">View</a> 
				<a href="./index.php?page=Sows&action=editSow&sowid='.$sow['sow_id'].'">Edit</a>';
				if($_SESSION['role']=="administrator")echo' <a class="deleteEntry" href="./index.php?page=Sows&action=deleteSow&sowid='.$sow['sow_id'].'">Delete</a>';
				echo'</td>
			</tr>';
		}
	}	
...
function displayCreateClientPage($conn){
	...
	echo'<form action="./index.php?page=Clients&action=addClient" method="post">
		<div class="entries">';
...
function displayEditClientPage($conn,$clientid){
	...
	if($result != null){
		...
		echo'<form action="./index.php?page=Clients&action=saveClientChanges" method="post">
			<div class="entries">';
			echo '<div class="sectionTitle"><h2>Client Details</h2></div>';				
			echo'<div class= "newEntryInfo-Threes">
			<span class="input_name">Company Name:</span><br/>
			...
			if($clientsSows !=null){
				...
				echo '<li>'.$sow['sow_name'].'<input type="button" class="viewer" data-url="./index.php?page=Sows&action=viewSow&sowid='.$sow['sow_id'].'" value="View S.O.W. Entry">
				<ul>
			...
			if($requests !=null){
				foreach($requests as $request){
					...
					echo' <li><span>'.$request['request_name'].'</span><input type="button" class="viewer" data-url="./index.php?page=Requests&action=viewRequest&requestid='.$request['request_id'].'" value="View Request Entry">
					<ul>
...
function displayViewClientPage($conn,$clientid){
	...
	if($result != null){
		...
		<button  class="buttonLink"><a href="./index.php?page=Clients&action=editClient&clientid='.$result['client_id'].'">Edit Client</a></button>';
		if($_SESSION['role']=="administrator")echo'<button  class="deleteEntry" data-url="./index.php?page=Clients&action=deleteClients&clientid='.$result['client_id'].'">Delete Client</button>';
		echo'<button  class="buttonLink"><a href="./index.php?page=Clients">Back To Clients Page</a></button>
		</div>';
	}
	else
	{
...
function displayClientsPage($conn){
	...
	<div class="searchbar">
			<form action="./index.php?page=Clients&action=Search" method="post">
				<input type="submit" name="search" value="Search Clients & Relations"> <input name="keyphrase" type="text" maxlength="45">';
			displayAdvancedSearchOption();
			echo'<input type="hidden" name="action_token" value="';echo html_escape($_SESSION['action_token']);echo'" /></form>
		</div>';
	...
	<a name="createClient" href="./index.php?page=Clients&action=createClient">Create New Client</a></button></div>';
...
function displayReportsPage($conn){
	...
	echo'<div class="searchbar">
			<form action="./index.php?page=Requests&action=Search" method="post">
				<input type="submit" name="search" value="Search Requests And Relations"> <input name="keyphrase" type="text" maxlength="45"><input type="hidden" name="Open" value="Yes">';
			displayAdvancedSearchOption();
			echo'<input type="hidden" name="action_token" value="';echo html_escape($_SESSION['action_token']);echo'" /></form>
		</div>';//div.searchbar
...
echo'<div class="table-framer">';
	...
	echo'<div class="searchbar">
			<form action="./index.php?page=Sows&action=Search" method="post">
				<input type="submit" name="search" value="Search S.O.W.s And Relations"> <input name="keyphrase" type="text" maxlength="45"><input type="hidden" name="Active" value="Yes">';
			displayAdvancedSearchOption();
			echo'<input type="hidden" name="action_token" value="';echo html_escape($_SESSION['action_token']);echo'" /></form>
		</div>';//div.searchbar
	...
	echo'<div class= "newEntryInfo-Threes">
	<form id="findQRes" action="./index.php?page=Resources&action=filterResources" method="post">
...
function displayCreateRequestPage($conn){
	...
	echo' <form action="./index.php?page=Requests&action=addRequest" method="post"
		...
		$resName="";
			...
			<input type="button" class="viewer displayRS" data-url="./index.php?page=Resources&action=editResource&resourceid='.$resource['resource_id'].'" value="View/Edit">
			</button><br/>';
		}
		echo'</span><br/>
...
function displayEditRequestPage($conn,$requestid){
	...
	if($request != null){
		...
		echo' <form action="./index.php?page=Requests&action=saveRequestChanges" method="post"
			enctype="multipart/form-data">';
			echo '<div class="entries">';
			echo '<div class="sectionTitle"><h2>Request Details</h2></div>';				
			echo'<div class= "newEntryInfo-Threes">
...
function displayViewRequestPage($conn,$requestid){
	...
	if($request != null){
		...
		echo '<div class="sectionTitle"><h2>Request Details</h2></div>';				
			...
			foreach($resources as $resource){
				if(in_array($resource['resource_id'],$resumesSent)){
					...
					if($resource['resource_lname'])$resName  = $resName.' '.$resource['resource_lname'];
					echo' <li> '.$resName.'
					<button class="viewer displayRS" data-url="./index.php?page=Resources&action=editResource&resourceid='.$resource['resource_id'].'">View/Edit
					</button></li>';
				}
			}
		...
		echo '</div>';//entries
		echo '<div class="nextPage">
		<button  class="buttonLink"><a href="./index.php?page=Requests&action=editRequest&requestid='.$request['request_id'].'">Edit Request</a></button>';
		if($_SESSION['role']=="administrator")echo'<button  class="deleteEntry" data-url="./index.php?page=Requests&action=deleteRequest&requestid='.$request['request_id'].'">Delete Request</button>';
		echo'<button  class="buttonLink"><a href="./index.php?page=Requests">Back To Requests Page</a></button>
		</div>';	
		}
		else{
			displayRequestsPage($conn);
...
function displayRequestsPage($conn){
	...
	//Addition Options for page. not relevant to any particular entry.
	echo'<div class="mgmtTools"><button type="button" id="createSow" style="background:none;"  class="buttonLink">
	<a href="./index.php?page=Requests&action=createRequest">Create New Requests</a></button></div>';//div.mgmtTools
...
function displayCreateResourcePage($conn){
	...
	echo'<form action="./index.php?page=Resources&action=addResource" method="post"
	enctype="multipart/form-data">
		<div class"entries">
...
function displayEditResourcePage($conn,$resourceid){
	...
	if($result != null){
		...
		echo'</h1></div>';
		echo'<form action="./index.php?page=Resources&action=saveResourceChanges" method="post"
			enctype="multipart/form-data">
			<div class="entries">';
			...
			if($result['resume_issi_upload']){
				echo'<br/><input type="button"class="viewer" data-url="./index.php?action=viewFile&directory=resume_issi_uploads&filename='.$result['resume_issi_upload'].'" value="View Resume ISSI"><br/>
			...
			echo'<br/><input type="button"class="viewer" data-url="./index.php?action=viewFile&directory=resume_uploads&filename='.$result['resume_upload'].'" value="View Resume"><br/>
...
function displayViewResourcePage($conn,$resourceid){
	...
	if($result != null){
		...
		echo'<div class="entries">';
			...
			if($result['resume_issi_upload']){
				echo'<button class="viewer" data-url="./index.php?action=viewFile&directory=resume_issi_uploads&filename='.$result['resume_issi_upload'].'">View Resume ISSI</button><br/>';
			...
			if($result['resume_upload']){
				echo'<button class="viewer" data-url="./index.php?action=viewFile&directory=resume_uploads&filename='.$result['resume_upload'].'">View Resume</button><br/>';
				echo'<span>Uploaded on: '.$result['resume_uploaded_date'].'<input type="hidden" name="resume_uploaded_date" value="'.$result['resume_uploaded_date'].'"></span>';
			...
			echo '</ul></div>';
			echo '<div class="nextPage">
		<button  class="buttonLink"><a href="./index.php?page=Resources&action=editResource&resourceid='.$result['resource_id'].'">Edit Resource</a></button>';
		if($_SESSION['role']=="administrator")echo'<button  class="deleteEntry" data-url="./index.php?page=Resources&action=deleteResource&resourceid='.$result['resource_id'].'">Delete Resource</button>';
		echo'<button  class="buttonLink"><a href="./index.php?page=Resources">Back To Resources Page</a></button>
		</div>';
	}
	else
	{
...
function displayResourcesPage($conn){
	...
	//Addition Options for page. not relevant to any particular entry.
	echo'<div class="mgmtTools"><button type="button" id="createUser" style="background:none;"  class="buttonLink">
	<a href="./index.php?page=Resources&action=createResource">Create New Resource</a></button></div>';//div.mgmtTools
...
function displayCreateSowPage($conn){
	...
	echo '<form action="./index.php?page=Sows&action=addSow" method="post"
		enctype="multipart/form-data">';
		echo '<div class="entries">';
...
function displayEditSowPage($conn,$sowid){
	...
	if($result != null){
		...
		echo '<form action="./index.php?page=Sows&action=saveSowChanges" method="post"
			enctype="multipart/form-data">';
			echo '<div class="entries">';
			echo '<div class="sectionTitle"><h2>S.O.W. Details</h2></div>';		
			echo'<div class= "newEntryInfo-Threes">
			...
			if($result['sow_upload'])echo'<input type="button"class="viewer" data-url="./index.php?action=viewFile&directory=sow_uploads&filename='.$result['sow_upload'].'" value="View S.O.W. File">';
			echo'<br/>
...
function displayViewSowPage($conn,$sowid){
	...
	if($result != null){
		...
		if($_SESSION['role']=="administrator")echo'<button  class="deleteEntry" data-url="./index.php?page=Sows&action=deleteSow&sowid='.$result['sow_id'].'">Delete Sow</button>';
...
function displaySowsPage($conn){
	...
	//Addition Options for page. not relevant to any particular entry.
	echo'<div class="mgmtTools"><button type="button" id="createSow" style="background:none;" class="buttonLink">
	<a href="./index.php?page=Sows&action=createSow">Create New Sow</a></button></div>';//div.mgmtTools
...
function displayCreateUserPage($conn){
	...
	echo'<form action="./index.php?page=Users&action=addUser" method="post">';
		echo'<div class="entries">';
		...
		<span class="ajaxResult" data-ref="username" data-url="./index.php?page=Ajax&action=checkUsername&username=">Invalid</span><br/>
...
function displayEditUserPage($conn,$userid){
	...
	echo'<form action="./index.php?page=Users&action=saveUserChanges" method="post">';
		echo'<div class="entries">';
		echo '<div class="sectionTitle"><h2>User Details</h2></div>';		
		echo'<div class= "newEntryInfo-Threes">
		<span class="input_name">First Name:</span><br/>
...
function displayViewUserPage($conn,$userid){
	...
	if($result != null){
		...
		echo '<div class="nextPage">
		<button  class="buttonLink"><a href="./index.php?page=Users&action=editUser&userid='.$result['user_id'].'">Edit User</a></button>';
		if($_SESSION['role']=="administrator" && $_SESSION['userid']==1)echo'<button  class="deleteEntry" data-url="./index.php?page=Users&action=deleteUser&userid='.$result['user_id'].'">Delete Resource</button>';
...
function displayUsersPage($conn){
	...
	<div class="searchbar">
			<form action="./index.php?page=Users&action=Search" method="post">
				<input type="submit" name="search" value="Search Users And Relations"> <input name="keyphrase" type="text" maxlength="45">';
			displayAdvancedSearchOption();
			echo'<input type="hidden" name="action_token" value="';echo html_escape($_SESSION['action_token']);echo'" /></form>
		</div>';//div.searchbar
	...
	//Addition Options for page. not relevant to any particular entry.
	echo'<div class="mgmtTools"><button type="button" id="createUser" style="background:none;"  class="buttonLink">
	<a href="./index.php?page=Users&action=createUser">Create New User</button></div>';//div.mgmtTools
	...
	if($results){
		foreach($results as $user){
			$creator = getCreator($conn,$user['created_by']);
			...
			<tr>
				<td>'.$user['user_fname'].'</td>
					...
					<a href="./index.php?page=Users&action=viewUser&userid='.$user['user_id'].'">View</a> ';
					if($_SESSION['role']=="administrator"){
					if($_SESSION['userid']==1
					|| $user['role']!= "administrator"
					|| $user['user_id'] == $_SESSION['userid'])echo '<a href="./index.php?page=Users&action=editUser&userid='.$user['user_id'].'">Edit</a>';
					}
					echo'</td>
				</tr>';
		}
...
$array =  array('something\'s  gos','<script></script>',12233465967454, '#$#^$%6z', '-asdadsad*(^)a');
print_r($array);

$array = anti_hack($array);
